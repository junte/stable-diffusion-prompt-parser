...
build:
	...
	GOOS=darwin GOARCH=arm64 go build -ldflags "-s -w" -o bin/prompt_mac_arm64 main.go
	GOOS=darwin GOARCH=amd64 go build -ldflags "-s -w" -o bin/prompt_mac_amd64 main.go
